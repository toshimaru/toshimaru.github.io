...
if (isLocal)
    B.origin = B.apiOrigin = B.staticOrigin = 'http://local.hatena.ne.jp:3000';
...
extend(B.BookmarkButton.prototype, {
    setup: function () {
        ...
        if (layout === 'simple') {
            ...
            this.frame = E('iframe', { className: 'hatena-bookmark-button-frame', title: this.link.title, frameBorder: 0, scrolling: 'no', allowTransparency: true, width: width, height: height });
    ...
    setup: function () {
        ...
        this.panel = E('div', { className: 'hatena-bookmark-bookmark-panel' },
            ...
            this.content = E('div', null,
                this.frame = E('iframe', { title: frameTitle, scrolling: 'no', frameBorder: 0, allowTransparency: true })
            )
        );
        this.setupStyle();
